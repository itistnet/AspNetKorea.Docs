...
{
  const uri = 'https://aspnetkoreadocs.azurewebsites.net/api/hits/Count/?url=' + encodeURIComponent(currentUrl);
...
AspNetKoreaDocs.SetShareArea = function(currentUrl)
{
  ...
  $('.divSocialArea').html(
    '<div class="divShare">' +
    ' <ul class="ulSnsList">' +
    '   <li><img src="/image/static/share_facebook.png" onclick="AspNetKoreaDocs.ShareSNS(&quot;facebook&quot;, &quot;' + currentUrl + '&quot;, &quot;' + currentTitle + '&quot;)" data-no-zoom></li>' + 
    '   <li><img src="/image/static/share_naver.png" onclick="AspNetKoreaDocs.ShareSNS(&quot;naver&quot;, &quot;' + currentUrl + '&quot;, &quot;' + currentTitle + '&quot;)" data-no-zoom></li>' + 
    '   <li><img src="/image/static/share_twitter.png" onclick="AspNetKoreaDocs.ShareSNS(&quot;twitter&quot;, &quot;' + currentUrl + '&quot;, &quot;' + currentTitle + '&quot;)" data-no-zoom></li>' + 
    '   <li><button onclick="AspNetKoreaDocs.ShareSNS(&quot;copy&quot;, &quot;' + currentUrl + '&quot;, &quot;' + currentUrl + '&quot;)">URL 복사</button>' + 
    ' </ul>' +
    '</div>'
  )  
}; 
...
AspNetKoreaDocs.ShareSNS = function(type, url, title) {
  ...
  var _top = Math.ceil((window.screen.height - _height) / 2);
	...
	switch(type){
		case 'facebook':
      _url = 'http://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(url);
      break;
    case 'naver' :
      _url = 'https://share.naver.com/web/shareView.nhn?url=' + encodeURI(encodeURIComponent(url)) + '&title=' + encodeURI(title);
      break;
		case 'twitter' :
      _url = 'http://twitter.com/intent/tweet?url=' + encodeURIComponent(url) + "&text=" + encodeURI(title);
			break;
		case 'kakaostory' :
  ...
  if (type !== 'copy')
  {
    window.open(_url, '', 'width='+ _width +', height='+ _height +', left=' + _left + ', top='+ _top + ', scrollbars=yes');
  }
};
